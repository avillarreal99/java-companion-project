            ...
            <div class="panel panel-default">
                ...
                <div class="formcontainer">
                    <form ng-submit="ctrl.addGame()" name="gameForm" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label class="col-md-2 control-lable text-light" for="game_genre">Genre</label>
                                <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="form-actions floatRight">
                                ...
                                <input data-ng-if="ctrl.game = {}" type="reset" value="Reset" class="btn btn-secondary btn-sm">
                            </div>
                        </div>
                    </form>
                </div>
